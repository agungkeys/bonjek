	...
	<div class="container-fluid">
		<div class="header">
			<h1 class="header-title">
				Selamat Datang, <span style="text-transform: capitalize;">{{Auth::user()->name}}</span>
			</h1>
			<p class="header-subtitle">{{Carbon\Carbon::now()->timezone('Asia/Makassar')->format('d-F-Y H:i')}}</p>
		</div>

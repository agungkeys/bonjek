<nav class="navbar navbar-expand navbar-theme">
	...
	<a class="btn btn-lg btn-pill btn-warning" href="/">Front Page &nbsp;<i class="align-middle fas fa-space-shuttle"></i></a>
	...
	<div class="navbar-collapse collapse">
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
				<a class="text-white" href="/logout"><i class="align-middle mr-1 fas fa-fw fa-arrow-alt-circle-right"></i> Sign out</a>
